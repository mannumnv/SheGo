...
public class CommuteController {
    ...
    ApiResponse<CommuteDtos.ScheduleResponse> create(@Valid @RequestBody CommuteDtos.ScheduleRequest request) {
        ...
        if (request.preferredDriverId() != null) {
            schedule.setPreferredDriver(drivers.findById(request.preferredDriverId())
                    .orElseThrow(() -> new BusinessException("Preferred driver not found", HttpStatus.NOT_FOUND)));
        }
    ...
    ApiResponse<CommuteDtos.ScheduleResponse> pause(@PathVariable UUID id) {
        CommuteSchedule schedule = schedules.findById(id)
                .orElseThrow(() -> new BusinessException("Commute schedule not found", HttpStatus.NOT_FOUND));
